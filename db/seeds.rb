...
puts "creating a concert seed Led Zeppelin"
Concert.create!(city: "Montreal", venue: "Olympic Stadium", date: "October 1st, 2022", average_rating: "9.5", artist: "Bowie's favorite band")
puts "done!"
