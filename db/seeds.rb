...
bowie = User.new(username: "Bowie", age: 23, city: "Montreal", bio: "Hello there! I am Bowie, a super cool dude from Montreal.",
             email: "bowie@bowie.com", password: "123456")
bowie.avatar.attach(io: avatar, filename: "avatar.png", content_type: "image/png")
bowie.banner.attach(io: banner, filename: "banner.png", content_type: "image/png")
bowie.save!
